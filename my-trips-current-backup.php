...
<div class="page-wrap">
    ...
    <main class="main-layout">
        ...
        <section class="plan-column">
            ...
            <div class="plan-card">
                ...
                >
                    ...
                    <!-- FINAL DAY BUDGET BUTTON -->
                    <div class="day-budget-area">
                        <button
                            type="button"
                            class="day-budget-trigger floating-budget-btn"
                        ...
                        >
                            ...
                            <span class="budget-trigger-text">
                                ...
                                <em><?php echo money($dayTotal); ?> planned today</em>
                            </span>
                            <span class="budget-trigger-arrow"><i class="fa-solid fa-arrow-right"></i></span>
                        </button>
                    </div>
                    ...
                    <?php if ($day < $days): ?>
                        <button
                            type="button"
                            class="continue-day-card"
                            data-target-day="<?php echo $day + 1; ?>"
                        >
                            <span class="continue-day-orb"><i class="fa-solid fa-route"></i></span>
                            <span class="continue-day-copy">
                                <small>YOUR JOURNEY CONTINUES</small>
                                <strong>Ready for Day <?php echo $day + 1; ?>?</strong>
                                <em>Continue your travel story without going back to the top.</em>
                            </span>
                            <span class="continue-day-arrow">
                                View Day <?php echo $day + 1; ?> <i class="fa-solid fa-arrow-right"></i>
                            </span>
                        </button>
                    <?php else: ?>
                        <button type="button" class="continue-day-card trip-finish-card" onclick="showTripFinished()">
                            <span class="continue-day-orb"><i class="fa-solid fa-flag-checkered"></i></span>
                            <span class="continue-day-copy">
                                <small>JOURNEY COMPLETE</small>
                                <strong>Your trip story ends here</strong>
                                <em>Save your personalised plan and keep the memories.</em>
                            </span>
                            <span class="continue-day-arrow">Finish Trip <i class="fa-solid fa-arrow-right"></i></span>
                        </button>
                    <?php endif; ?>
        ...
        <aside class="right-column final-right-column">
            ...
            <div class="side-card trip-actions-card glow-card">
                <div class="small-label">TRIP ACTIONS</div>
                <h3>Keep Your Trip Plan Handy</h3>
                <p class="actions-subtitle">Share the plan, copy the link or save only your trip plan as a PDF.</p>

                <div class="trip-action-grid">
                    <button type="button" class="trip-action-btn whatsapp-action" onclick="shareTripWhatsApp()">
                        <i class="fa-brands fa-whatsapp"></i><span>WhatsApp</span><small>Share Plan</small>
                    </button>
                    <button type="button" class="trip-action-btn copy-action" onclick="copyTripLink()">
                        <i class="fa-solid fa-link"></i><span>Copy Plan</span><small>Save Link</small>
                    </button>
                    <button type="button" class="trip-action-btn pdf-action" onclick="downloadTripPDF()">
                        <i class="fa-solid fa-file-pdf"></i><span>Save PDF</span><small>Plan Only</small>
                    </button>
                </div>

                <div class="save-trip-status" id="tripActionStatus">
                    <i class="fa-solid fa-circle-check"></i> Your personalised plan is ready
                </div>
            </div>

            <div class="side-card hospital-card glow-card">
                <div class="small-label">NEARBY HELP</div>
                <div class="hospital-content">
                    <div class="hospital-icon"><i class="fa-solid fa-hospital"></i></div>
                    <div>
                        <h3>Find Nearby Hospital</h3>
                        <p>Open the hospital map near your current trip destination.</p>
                    </div>
                </div>
                <a href="https://www.google.com/maps/search/Hospital+near+<?php echo rawurlencode($placeName); ?>" target="_blank" rel="noopener" class="hospital-map-btn">
                    <i class="fa-solid fa-map-location-dot"></i>
                    <span>Open Hospital Map</span>
                    <i class="fa-solid fa-arrow-up-right-from-square"></i>
                </a>
            </div>

            <div class="side-card safety-card glow-card">
                <div class="small-label">TRAVEL SAFETY</div>
                <div class="safety-top">
                    <div class="safety-icon"><i class="fa-solid fa-shield-heart"></i></div>
                    <div><h3>Stay Safe</h3><p>Small reminders for a smoother journey.</p></div>
                </div>
                <div class="safety-points">
                    <div><i class="fa-solid fa-check"></i><span>Keep emergency contacts ready</span></div>
                    <div><i class="fa-solid fa-check"></i><span>Carry water and travel essentials</span></div>
                    <div><i class="fa-solid fa-check"></i><span>Follow local travel instructions</span></div>
                </div>
            </div>

            <div class="side-card quick-actions-final glow-card">
                <div class="small-label">QUICK ACTIONS</div>
                <h3>Need Something Quickly?</h3>

                <a href="https://www.google.com/maps/search/Police+Station+near+<?php echo rawurlencode($placeName); ?>" target="_blank" rel="noopener" class="quick-action-item">
                    <span class="quick-action-icon police"><i class="fa-solid fa-shield-halved"></i></span>
                    <span><strong>Police Station</strong><small>Open nearby map</small></span>
                    <i class="fa-solid fa-chevron-right"></i>
                </a>

                <a href="https://www.google.com/maps/search/ATM+near+<?php echo rawurlencode($placeName); ?>" target="_blank" rel="noopener" class="quick-action-item">
                    <span class="quick-action-icon atm"><i class="fa-solid fa-building-columns"></i></span>
                    <span><strong>Nearby ATM</strong><small>Find cash access</small></span>
                    <i class="fa-solid fa-chevron-right"></i>
                </a>

                <a href="tel:112" class="quick-action-item emergency">
                    <span class="quick-action-icon emergency-icon"><i class="fa-solid fa-phone-volume"></i></span>
                    <span><strong>Emergency Help</strong><small>Call 112</small></span>
                    <i class="fa-solid fa-chevron-right"></i>
                </a>
            </div>
    ...
    <!-- =================================================
         FINAL BOTTOM - SHOPPING ONLY
    ================================================= -->
    <section class="bottom-grid final-bottom-grid">
        <div class="recommend-card shopping-preview-card glow-card">
            ...
            <div class="shopping-row">
                <div><img src="<?php echo htmlspecialchars($shoppingImages[0]); ?>" alt="Local shopping"><span>Local Chocolates</span></div>
                <div><img src="<?php echo htmlspecialchars($shoppingImages[1]); ?>" alt="Local products"><span>Local Products</span></div>
                <div><img src="<?php echo htmlspecialchars($shoppingImages[2]); ?>" alt="Tea and spices"><span>Spices &amp; Tea</span></div>
...
document.addEventListener("click", function(e){
    const next = e.target.closest(".continue-day-card[data-target-day]");
    if(next){
        const day = next.dataset.targetDay;
    ...
    const card = e.target.closest(".glow-card, .floating-budget-btn");
    if(card){
        card.classList.add("active-glow");
        setTimeout(()=>card.classList.remove("active-glow"),900);
    }
});
</script>
